...
Google Drive com os Arquivos abaixo: # Otimização de Hiperparâmetros via Algoritmos Genéticos para Classificação de Texto
...
Defina a licença do repositório (por exemplo, MIT para o código e CC BY 4.0 para dados e figuras) antes da publicação pública.
